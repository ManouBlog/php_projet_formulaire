...
<body>
   ...
   <main >
        ...
        <h1>
         <?php echo "Bienvenue  ".$_SESSION["first_name"] ;?>
      </h1>
      <h2>
      <?php echo "Nom : ".$_SESSION["first_name"];?> 
     </h2>
      <h2>
      <?php echo "Prénoms : ".$_SESSION["second_name"];?> 
     </h2>
      <h2>
      <?php echo "Email : ".$_SESSION["email"];?> 
      </h2>
      <h2>
      <?php echo "votre profil a éte creer le : ".$_SESSION["creation"];?> 
      </h2>
